        ...
        <section style={{ marginTop: '60px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button title="Previous" className="buttonNav" onClick={() => setCurrentPage((p) => Math.max(0, p - 1))} disabled={currentPage === 0}>
              ...
              <button
                ...
                className="buttonNav"
                onClick={() =>
                  setCurrentPage((p) => (p < Math.ceil(sampleReviews.length / REVIEWS_PER_PAGE) - 1 ? p + 1 : p))
                }
